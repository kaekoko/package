...
namespace Renamepackage\ShoppingCart;

use Illuminate\Support\Collection;
use Renamepackage\ShoppingCart\Coupons\Coupon;
use Renamepackage\ShoppingCart\Repositories\ShoppingCartRepositoryInterface;
